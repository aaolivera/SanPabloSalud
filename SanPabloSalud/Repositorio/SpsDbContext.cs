...
namespace Repositorio
{
    ...
    public class SpsDbContext : DbContext
    {
        ...
        public SpsDbContext() : base("spsdb")
        {
            //Database.SetInitializer(new MigrateDatabaseToLatestVersion<SpsDbContext, Migrations.Configuration>("spsdb"));
        }
        public SpsDbContext(string connStringName) : base(connStringName) { }
        static SpsDbContext()
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            MapearAssemblyDe<Paciente>(modelBuilder, x => x.Namespace == typeof(Paciente).Namespace, 
                excluir: null);
